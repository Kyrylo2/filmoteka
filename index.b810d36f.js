 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function br(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Ir(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(vr(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(_r(t))return"Blackberry";if(Tr(t))return"Webos";if(wr(t))return"Safari";if((t.includes("chrome/")||Er(t))&&!t.includes("edge/"))return"Chrome";if(kr(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function vr(e=B()){return/firefox\//i.test(e)}function wr(e=B()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Er(e=B()){return/crios\//i.test(e)}function Ir(e=B()){return/iemobile/i.test(e)}function kr(e=B()){return/android/i.test(e)}function _r(e=B()){return/blackberry/i.test(e)}function Tr(e=B()){return/webos/i.test(e)}function xr(e=B()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Sr(){return U()&&10===document.documentMode}function Nr(e=B()){return xr(e)||kr(e)||Tr(e)||_r(e)||/windows phone/i.test(e)||Ir(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gi=new qn(3e4,6e4);function Ji(){const e=hi().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Xi=null;function Qi(e){return Xi=Xi||function(e){return new Promise(((t,n)=>{var r,i,o;function s(){Ji(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Ji(),n(Ln(e,"network-request-failed"))},timeout:Gi.get()})}if(null===(i=null===(r=hi().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=hi().gapi)||void 0===o?void 0:o.load)){const t=ki("iframefcb");return hi()[t]=()=>{gapi.load?s():n(Ln(e,"network-request-failed"))},Ii(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Xi=null,e}))}(e),Xi}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const co=H("authIdTokenMaxAge")||300;let lo=null;function uo(e=He()){const t=Fe(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Fe(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(X(n.getOptions(),null!=t?t:{}))return e;Rn(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:so,persistence:[Ei,ai,li]}),r=H("authTokenSyncURL");if(r){const e=(i=r,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>co)return;const r=null==t?void 0:t.token;lo!==r&&(lo=r,await fetch(i,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))});!function(e,t,n){ie(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,r){ie(e).onIdTokenChanged(t,n,r)}(n,(t=>e(t)))}var i;const o=$("auth");return o&&Pr(n,`http://${o}`),n}var fo;fo="Browser",je(new he("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),{apiKey:i,authDomain:o}=n.options;return((e,n)=>{Mn(i&&!i.includes(":"),"invalid-api-key",{appName:e.name}),Mn(!(null==o?void 0:o.includes(":")),"argument-error",{appName:e.name});const r={apiKey:i,authDomain:o,clientPlatform:fo,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Or(fo)},s=new Cr(e,n,r);return function(e,t){const n=(null==t?void 0:t.persistence)||[],r=(Array.isArray(n)?n:[n]).map(zn);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(r,null==t?void 0:t.popupRedirectResolver)}(s,t),s})(n,r)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),je(new he("auth-internal",(e=>{const t=Rr(e.getProvider("auth").getImmediate());return new ao(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Ve("@firebase/auth","0.21.0",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(fo)),Ve("@firebase/auth","0.21.0","esm2017");let ho;const po=new class{async signInGoogle(){const e=new Jr;await Li(uo(),e)}async signInFacebook(){const e=new Gr;await Li(uo(),e)}signOutUser(){ie(uo()).signOut()}initFirebaseAuth(){var e,t,n,r;e=uo(),t=this.authStateObserver.bind(this),ie(e).onAuthStateChanged(t,n,r)}getProfilePicUrl(){return uo().currentUser.photoURL||"/images/profile_placeholder.png"}getUserName(){return uo().currentUser.displayName}isUserSignedIn(){return!!uo().currentUser}addSizeToGoogleProfilePic(e){return-1!==e.indexOf("googleusercontent.com")&&-1===e.indexOf("?")?e+"?sz=150":e}constructor(e){this.authStateObserver=e;$e(g());Tn(),this.initFirebaseAuth()}}((function(e){e?(ho.signOutButtonElement.classList.remove("visually-hidden"),ho.signInButtonElement.classList.add("visually-hidden")):(ho.signOutButtonElement.classList.add("visually-hidden"),ho.signInButtonElement.classList.remove("visually-hidden"))}));function mo(){document.addEventListener("keydown",go),ho.signInBackdrop.addEventListener("click",yo),document.body.classList.add("no-scroll-body"),ho.signInMenu.classList.remove("visually-hidden"),ho.signInBackdrop.classList.remove("visually-hidden")}function go(e){"Escape"===e.key&&bo(e)}function yo(e){bo(e)}function bo(e){document.removeEventListener("keydown",go),ho.signInBackdrop.removeEventListener("click",yo),document.body.classList.remove("no-scroll-body"),ho.signInMenu.classList.add("visually-hidden"),ho.signInBackdrop.classList.add("visually-hidden")}f.search.addEventListener("submit",(async function(e){e.preventDefault(),p.query=e.currentTarget.elements.searchQuery.value,f.filmsMainContainer.innerHTML="",p.resetPage();try{const e=await p.fetchMovies();t=a(e),f.filmsMainContainer.innerHTML=t}catch(e){h.Notify.failure("Oups! Something went wrong")}var t})),f.filmsMainContainer.addEventListener("click",(function(e){e.preventDefault();const t=e.target.closest("li").getAttribute("data-id");p.getFullInfo(t),f.modal.classList.remove("visually-hidden"),f.backdrop.classList.toggle("modal-open")})),f.backdrop.addEventListener("click",(e=>{(e.target.classList.contains("modal")||e.target.classList.contains("backdrop"))&&(f.modal.classList.add("visually-hidden"),f.backdrop.classList.toggle("modal-open"))})),ho={signInButtonElement:document.getElementById("signInButton"),signOutButtonElement:document.getElementById("signOutButton"),signInMenu:document.getElementById("menu_sign_in"),signInGoogleButtonElement:document.getElementById("btn-sign-in-google"),signInFacebookButtonElement:document.getElementById("btn-sign-in-facebook"),signInBackdrop:document.getElementById("backdrop_menu_sign_in")},ho.signInButtonElement.addEventListener("click",mo),ho.signInGoogleButtonElement.addEventListener("click",po.signInGoogle.bind(po)),ho.signInFacebookButtonElement.addEventListener("click",po.signInFacebook.bind(po)),ho.signOutButtonElement.addEventListener("click",po.signOutUser.bind(po)),ho.signInGoogleButtonElement.addEventListener("click",bo),ho.signInFacebookButtonElement.addEventListener("click",bo),p.getGenres(),p.getTrendMovies();
//# sourceMappingURL=index.b810d36f.js.map
